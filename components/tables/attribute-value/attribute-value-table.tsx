...
const AttributeValueTable: React.FC<ITableProps> = ({ trans }) => {
    ...
    // Function to fetch attribute value data
    const handleFetchAttributeValue = async () => {
        try {
