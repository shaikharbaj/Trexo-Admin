...
const FinancierTable: React.FC<ITableProps> = ({ trans }) => {
  ...
  // Function to fetch financier data
  const handleFetchFinancier = async () => {
    try {
