...
import { FaqTypeFilter } from "./faq-type.filter";
...
export function Toolbar({ table, isFilterEnable, trans }: ToolbarProps) {
  ...
  const viewOptionLabel = {
    ...
    faq_type: trans('FAQ Type'),
    faq_category: trans('FAQ Category'),
  ...
  return (
    <div className="flex flex-1 flex-wrap items-center gap-2">
      ...
      {FaqTypeOptions.length && (
        <FaqTypeFilter
          title={trans('FAQ Type')}
