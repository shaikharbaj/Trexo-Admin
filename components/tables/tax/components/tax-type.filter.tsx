...
import { filterStatus, filterTaxType } from "@/service/datatable.service";
...
export function TaxTypeFilter({ title, options }: FilterProps) {
  ...
  const handelFilter = async () => {
    await filterTaxType(selectedValues);
  };
