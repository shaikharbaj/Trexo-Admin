...
import { filterFaqType, filterStatus } from "@/service/datatable.service";
...
export function FaqTypeFilter({ title, options }: FilterProps) {
    ...
    const handelFilter = async () => {
        await filterFaqType(selectedValues);
    };
