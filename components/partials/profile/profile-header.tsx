...
const ProfileHeader: React.FC<IProfileHeaderProps> = ({ basicinformation }) => {
  return (
    <Fragment>
          ...
          >
            ...
            <div className="flex items-center gap-4 absolute ltr:left-10 rtl:right-10 ">
              ...
              <div>
                {basicinformation && (
                  <>
                    <div className="text-xl lg:text-2xl font-semibold text-primary-foreground mb-1">{`${basicinformation?.first_name} ${basicinformation?.last_name}`}</div>
