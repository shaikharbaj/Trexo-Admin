      ...
      <ScrollArea className="h-full">
        <div className=" space-y-3">
          <div className="flex flex-col gap-2">
            <Label>{trans("Country Name")}<span className="text-destructive">*</span></Label>
            <Input
              disabled={isPending}
              type="text"
              size="lg"
          ...
          <div className="flex flex-col gap-2">
            <Label>{trans("ISO Code")}<span className="text-destructive">*</span></Label>
            <Input
              disabled={isPending}
              type="text"
              size="lg"
          ...
          <div className="flex flex-col gap-2">
            <Label>{trans("Mobile Code")}<span className="text-destructive">*</span></Label>
            <Input
              disabled={isPending}
              type="text"
              size="lg"
          ...
          <div className="flex flex-col gap-2">
            <Label>{trans("Currency Code")}<span className="text-destructive">*</span></Label>
            <Input
              disabled={isPending}
              type="text"
              size="lg"
