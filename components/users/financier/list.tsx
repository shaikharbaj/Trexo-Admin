...
import { FinancierTable } from "@/components/tables";
import { useAppSelector } from "@/hooks";
import { RootState } from "@/redux/store";

interface IFinancierProps {}

const FinancierList: React.FunctionComponent<IFinancierProps> = () => {
    ...
    <div className="space-y-6">
      <div className="flex items-center flex-wrap justify-between gap-4">
        <Breadcrumbs>
          ...
          <BreadcrumbItem>{t("Financier")}</BreadcrumbItem>
        </Breadcrumbs>
      </div>
      <div className="space-y-6">
        <div className="flex items-center flex-wrap justify-between gap-4">
      ...
      <div className="grid grid-cols-1 gap-6">
        <Card>
          <CardContent className="pt-6">
            <FinancierTable key={String(refresh)} trans={t} />
          </CardContent>
        </Card>
      </div>
    </div>
