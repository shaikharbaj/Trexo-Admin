...
import { SocialMediaForm } from "@/components/forms";
...
import {
  createSocialMedia,
  updateSocialMedia,
} from "@/service/social-media.service";
...
const CreateUpdateSocialMediaModal: React.FC<IModalProps> = ({ trans }) => {
    ...
    startTransition(async () => {
      try {
        ...
        if (action === "add") {
          ...
          response = await updateSocialMedia(data?.uuid, payload);
        }
  ...
  return (
    <Dialog open={modalName === "social-media" && isOpen}>
...
export default CreateUpdateSocialMediaModal;
